...
PILS_EPICS_GENERATOR_REPO_URL = 'https://github.com/ess-dmsc/pils-epics-generator'
PILS_EPICS_GENERATOR_REPO_VERSION = git.Repo(search_parent_directories=True).git.rev_parse("--short", "HEAD")
TOM_TEMPLATE_VERSION = '11.0'
...
class DeviceCollection:
    ...
    def get_xml_start(self, mc_unit):
        ...
        cdata_content = [
            'VAR_GLOBAL',
            f'(** Autogenerated by pils-epics-generator version {PILS_EPICS_GENERATOR_REPO_VERSION}',
            f' * {PILS_EPICS_GENERATOR_REPO_URL}',
            f' * Table of motion version: {TOM_TEMPLATE_VERSION}',
            ' *)',
            '',
            f"sPLCName: STRING[34] := '{self.instrument.lower()}-mcs{mc_unit}';",  # TODO: Replace with actual PLC name
            f"sPLCVersion: STRING[34] := '{PILS_EPICS_GENERATOR_REPO_VERSION}';",
            f"sPLCAuthor1: STRING[34] := '{PILS_EPICS_GENERATOR_REPO_URL[:19]}';",
            f"sPLCAuthor2: STRING[34] := '{PILS_EPICS_GENERATOR_REPO_URL[19:]}';\n",
        ]
